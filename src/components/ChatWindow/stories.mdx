...
export const Template = (args) => <ChatWindow {...args} />;

# Chat Window

The `<ChatWindow />` component is a multi-chat window, for a User to manage their chats.
...
`import { ChatWindow } from "react-chat-engine-advanced";`
