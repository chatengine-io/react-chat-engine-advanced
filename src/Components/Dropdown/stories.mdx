...
<Meta
  ...
  argTypes={{
    ...
    selectedStyle: { table: { category: 'styles' } },
  }}
/>
...
Dropdown is used in settings to display aspects of chat rooms.
...
<Story
  ...
  args={{
    ...
    labelStyle: { border: '2px solid green' },
    bodyStyle: { border: '2px solid orange' },
    selectedStyle: { border: '2px solid black' },
  }}
>
  {Template.bind({})}
</Story>
