...
You can use the `customStyle` prop, which has a `MessageStyle` interface, to customize every aspect of the message CSS.
  ...
  <Story
    ...
    args={{
      ...
      customStyle: {
        ...
        senderText: { border: '2px solid blue' },
        dot: { border: '2px solid cyan' },
        attachment: { border: '2px solid orange' },
        message: { border: '2px solid green' },
        timeTag: { border: '2px solid brown' },
      },
    }}
  >
    {Template.bind({})}
