...
<Meta
  ...
  argTypes={{
    ...
    onChatLoaderVisible: { table: { category: 'hooks' } },
    onTopMessageShow: { table: { category: 'hooks' } },
    onBottomMessageShow: { table: { category: 'hooks' } },
    onMessageSend: { table: { category: 'hooks' } },
...
<Story
  ...
  args={{
    ...
    onChatLoaderVisible: () => console.log('onChatLoaderVisible'),
    onTopMessageShow: () => console.log('onTopMessageShow'),
    onBottomMessageShow: () => console.log('onBottomMessageShow'),
    onMessageSend: () => console.log('onMessageSend'),
    chatEngineStyle: {
      height: '550px',
      boxShadow: '0px 0px 3px 6px rgba(0, 0, 0, 0.1)',
    },
