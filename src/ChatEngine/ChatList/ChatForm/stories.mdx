...
<Meta
  ...
  argTypes={{
    ...
    chatFormStyle: { table: { category: 'styles' } },
    myChatsTitleStyle: { table: { category: 'styles' } },
    chatFormInputStyle: { table: { category: 'styles' } },
    chatFormButtonStyle: { table: { category: 'styles' } },
  }}
/>
