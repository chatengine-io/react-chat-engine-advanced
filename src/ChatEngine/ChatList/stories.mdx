...
You can render you own code for sub-components withing Chat Feed.

<Story
  name="Render Functions 2"
  args={{
    chats: chats,
    renderChatForm: () => <div>Your Chat Form code here!</div>,
    renderChatCard: () => <div>Your Chat Card code here!</div>,
    chatListStyle: {
      maxWidth: '400px',
      boxShadow: '0px 0px 3px 6px rgba(0, 0, 0, 0.1)',
      maxHeight: '330px',
