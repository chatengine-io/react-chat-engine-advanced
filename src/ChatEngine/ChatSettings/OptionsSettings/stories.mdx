...
<Meta
  ...
  argTypes={{
    onDeleteChat: { table: { category: 'hooks' } },
...
When the user click on Delete Chat button, you can run your code on the `onDeleteChat` hook.
...
<Canvas>
  <Story
    ...
    args={{
      ...
      onDeleteChat: (chat) => console.log('Delete chat', chat),
      style: {
        maxWidth: '400px',
        boxShadow: '0px 0px 3px 6px rgba(0, 0, 0, 0.1)',
      },
